...
def register():
    ...
    # Apply saved preference states (e.g. disabled pie menus) onto the
    # freshly registered keymaps so the user's choices survive restarts.
    HEAVYPOLY_startup.apply_prefs()
